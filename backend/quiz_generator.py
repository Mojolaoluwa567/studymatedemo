...
STAGE 2 — HARD (main objective exam, MCQ only)
  Format A: 60 questions × 1 mark = 60 marks, 45 min
  Format B: 30 questions × 2 marks = 60 marks, 35 min
...
# Theory was moved entirely to Difficult - Hard is pure objective.
# ---------------------------------------------------------------------------
HARD_MODES = {
    60: {
        "mcq_count": 60,
